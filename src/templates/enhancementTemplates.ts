...
export function getTemplateByName(template: EnhancementTemplate): TemplateDefinition {
  return ENHANCEMENT_TEMPLATES[template];
}

export function getAllTemplates(): TemplateDefinition[] {
  return Object.values(ENHANCEMENT_TEMPLATES);
}