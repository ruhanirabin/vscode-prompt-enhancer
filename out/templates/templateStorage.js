...
exports.TemplateStorage = void 0;
...
class TemplateStorage {
     ...
     */
    static async loadTemplates(context) {
     ...
     */
    static async loadBuiltInTemplates(context) {
        const templates = [];
     ...
     */
    static async loadUserTemplates(context) {
        try {
     ...
     */
    static async saveTemplate(context, template) {
     ...
     */
    static async deleteTemplate(context, templateId) {
        try {
            const userTemplates = await this.loadUserTemplates(context);
     ...
     */
    static async exportTemplates(templates) {
        const exportData = {
            version: '1.0.0',
     ...
     */
    static async importTemplates(context, jsonData) {
        try {
     ...
     */
    static async templateExists(context, templateId) {
...
TemplateStorage.STORAGE_KEY = 'promptEnhancer.customTemplates';
TemplateStorage.BUILT_IN_TEMPLATES_DIR = 'templates/built-in';
//# sourceMappingURL=templateStorage.js.map